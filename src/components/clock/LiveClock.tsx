    ...
    <div className="clock-w">
      <div className="clock-ring">
        ...
        <div className="clock-face">
          ...
          <div className="big">
            {displayHours}:{displayMinutes}<span className="sec">{displaySeconds}</span>
          </div>
        </div>
      </div>
        ...
        <div className="meta">
          ...
          <span>
            {activeSessions.length > 0
              ? `Timers running (${activeSessions.length}) · ${activeSessions.map(s => s.projectName + (s.pausedAt ? ' (Paused)' : '')).join(', ')}`
              : 'No active session'}
          </span>
          {nextTask ? (
            <>
